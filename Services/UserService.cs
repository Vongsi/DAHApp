using DAHApp.Constants;
using DAHApp.Contexts;
using DAHApp.Controllers;
using DAHApp.Models;
...
namespace DAHApp.Services
{
    public class UserService : IUserService
    {
        ...
        private readonly ILogger<UserService> _loggerUserService;

        public UserService(UserManager<ApplicationUser> userManager
            , RoleManager<IdentityRole> roleManager
            , IOptions<JWT> jwt
            , ApplicationDbContext context, ILogger<UserService> loggerUserService)
        {
            _context = context;
        ...
        public async Task<AuthenticationModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            _loggerUserService.LogInformation(model.Email);
            ...
            _loggerUserService.LogInformation(authenticationModel.Message);
